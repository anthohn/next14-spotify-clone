    ...
    return (
        <>
            <div className="flex flex-col  w-[420px] rounded-lg text-[15px] text-neutral-400">
                ...
                <div className="pl-2 pr-2 flex flex-col space-y-2 overflow-y flex-grow overflow-y-auto bg-neutral-950 scrollbar scrollbar-thumb-neutral-600 hover:scrollbar-thumb-neutral-500">
                    ...
                    <div>
                        {playlists.map((playlist) => (
                            <a href={playlist.external_urls.spotify} target="_blank" rel="noopener noreferrer" key={`${playlist.id}`} className="flex hover:bg-neutral-900 w-full rounded items-center py-2 space-x-3"> 
                                <Image 
