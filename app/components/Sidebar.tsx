...
export default function Sidebar() {
    return (
        <>
            <div className="flex flex-col space-y-2 w-[26rem] rounded-lg text-[15px] text-neutral-300">
                <div className="flex flex-col py-5 space-y-6 font-medium rounded-lg bg-neutral-900">
                    <Link href="/" className="flex space-x-5 items-center mx-6 font-semibold hover:text-gray-100">
                ...
                <div className="flex flex-col py-4 space-y-6 font-medium rounded-lg bg-neutral-900 flex-grow ">
                    <div className="flex justify-between ml-6 mr-4">
                        <Link href="/" className="flex space-x-3 items-center  font-semibold  hover:text-gray-100">
                        ...
                        <div className="flex space-x-4">
                            <svg data-encore-id="icon" role="img" aria-hidden="true" viewBox="0 0 16 16" className="Svg-sc-ytk21e-0 kPpCsU"><path d="M15.25 8a.75.75 0 0 1-.75.75H8.75v5.75a.75.75 0 0 1-1.5 0V8.75H1.5a.75.75 0 0 1 0-1.5h5.75V1.5a.75.75 0 0 1 1.5 0v5.75h5.75a.75.75 0 0 1 .75.75z"></path></svg>

                            <button className=" bg-red-500 px-2 rounded-full text-3xl">
                                {/* <p>asd.</p> */}
                                <svg data-encore-id="icon" viewBox="0 0 16 16" className="Svg-sc-ytk21e-0 kPpCsU"><path d="M15.25 8a.75.75 0 0 1-.75.75H8.75v5.75a.75.75 0 0 1-1.5 0V8.75H1.5a.75.75 0 0 1 0-1.5h5.75V1.5a.75.75 0 0 1 1.5 0v5.75h5.75a.75.75 0 0 1 .75.75z"></path></svg>
                            </button>
