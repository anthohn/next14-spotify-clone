...
export default function Sidebar() {
    return (
        <>
            <div className="flex flex-col space-y-2 w-[420px] rounded-lg text-[15px] text-neutral-400">
                <div className="flex flex-col py-2 px-2 font-medium rounded-lg bg-neutral-900">
                ...
                <div className="flex flex-col space-y-2 font-medium rounded-lg bg-neutral-900 flex-grow ">
                    ...
                    <div className="flex space-x-2 px-4 items-center text-[13px] text-neutral-100 w-max ">
                    ...
                    <div className="flex justify-between  px-4 items-center">
                        <button className="hover:bg-neutral-800 px-2 py-2 rounded-full hover:cursor-default">
                        ...
                        <button className="flex items-center  space-x-1 hover:text-neutral-800 px-2 py-2">
